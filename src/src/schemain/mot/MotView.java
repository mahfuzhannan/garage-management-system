 ...
 * @author Mahfuz
 */
public class MotView extends JDialog{
    ...
    private JComboBox customerIdField, bayField, mechanicField, startTimeField,
            vehicleIdField, passField;
    ...
    public MotView(JFrame parent, boolean modal, boolean update) {
        super(parent, modal);
        this.update = update;
        init();
    }
    ...
    public final void init() {
        ...
        * PASS OR FAIL
        */
        label = new JLabel("Pass or Fail: ");
        label.setSize(w, h);
        label.setForeground(Res.FONT_COLOR);
        passField = new JComboBox(new DefaultComboBoxModel(new String[]{"Pass", "Fail"}));
        passField.setSize(w, h);
        ...
        */
        ...
        reasonField.setBorder(new BevelBorder(BevelBorder.LOWERED, Res.SHADOW, Res.SHADOW));
        reasonField.setForeground(Res.BKG_COLOR);
        reasonField.setEnabled(false);
        panel.add(label);
        panel.add(reasonField);
        
        // create title label
        label = new JLabel("Add MoT");
        label.setFont(new Font("", 0, 26));
        label.setForeground(Res.FONT_COLOR);
        label.setBackground(Res.BKG_COLOR);
        label.setHorizontalAlignment(SwingConstants.CENTER);
        if(isUpdate())
            label.setText("Update MoT");
    ...
    public void addPassListener(ActionListener act) {
        this.passField.addActionListener(act);
    }
    ...
    public boolean getPass() {
        String val = passField.getSelectedItem().toString();
    ...
    public String getNextService() {
        return passField.getSelectedItem().toString();
    }
    ...
    public JComboBox getPassField() {
        return passField;
    }

    public JTextArea getReasonField() {
        return reasonField;
    }
